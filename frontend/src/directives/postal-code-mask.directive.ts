...
/**
 * Directiva que aplica una máscara de entrada para códigos postales españoles.
 *
 * Reglas:
...
export class PostalCodeMaskDirective {
  ...
  onInput(event: Event): void {
    ...
    // Aplicar la máscara: solo números, máximo 5
  ...
  onKeyDown(event: KeyboardEvent): void {
    ...
    // Si ya tiene 5 dígitos, bloquear
  ...
  /**
   * Aplica la máscara: solo números, máximo 5 dígitos
   */
  private applyMask(value: string): string {
    ...
    // Limitar a 5 dígitos
    return onlyNumbers.substring(0, 5);
  }
